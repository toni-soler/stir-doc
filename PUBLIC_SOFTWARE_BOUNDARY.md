...
Any instance must build/run using public sources, public documented artifacts and locally generated secrets. Core 0.3.0 is a public binary exception to source reproducibility under its own license. STIR never builds private Core source.
